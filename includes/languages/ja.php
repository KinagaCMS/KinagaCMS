...
#サイドボックスのタイトル
$sidebox_title = ['新着記事', 'インフォメーション', '良く読まれている記事', '最近のコメント', 'ログイン', 'こんにちは。%sさん', '関連記事', 'シェア', '引用リンク', '目次', 'カテゴリ'];
...
$ticket_body =
	...
	'添付ファイル（%s）を保存し、'. $n. '10分以内（%sまで）に所定の場所にアップロードして下さい。'. $n. $n.
	'アップロード完了後は、保存したファイルと本メールを削除することができます。';

$ticket_title = ['ログイン・チケットを送信しました', 'ログイン・チケットのアップロード'];
$ticket_process = [
	'<strong>10分以内<small>（%sまで）</small></strong>に以下の操作を行って下さい。',
