...
　「紀永」とは、気長の読みに当て字して「末永く書く」という意味を持たせた縁起の良い名称のコンテンツマネジメントシステムのことであり、ファイルシステム管理型の構造を特徴とすることから、データベースやアドミン権限を必要としない安全性の高い簡易CMSに位置付けられます。
