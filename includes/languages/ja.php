...
$btn = ['訂正', '送信', '保存', '拒否', '削除', '承認', '掲載', '編集', 'プレビュー', '続きを読む…', '今すぐ購入', '売り切れ', 'ログインして購入', '閉じる', '新規作成', '決定', '成約御礼'];
...
$shop_mail_subject = [
	...
	'注文受付のお知らせ（自動送信メール） - %s',
	'命名権ご購入完了のお知らせ（自動送信メール） - %s',
	'命名権売却のお知らせ（自動送信メール） - %s',
	'商品ご購入完了のお知らせ（自動送信メール） - %s',
	'無形商品売却のお知らせ（自動送信メール） - %s',
];
...
[
	...
	'%s様'. $n. $n.
	'この度は、命名権をご購入頂きありがとうございました。'. $n.
	'ご入金を承っておりますので、下記の URL よりご命名頂ければ幸いです。'. $n. $n.
	'%s',

	'%s 様が %s の命名権を購入しました。'. $n. $n.
	'%s',

	'%s様'. $n. $n.
	'この度は、%s をご購入頂きありがとうございました。'. $n.
	'引き続き、本オンラインショップをご利用頂ければ幸いです。'. $n,

	'%s 様が無形商品「%s」を購入しました。'. $n. $n.
	'%s',
];

$naming_rights_message = [
'%s 様、%s をご購入下さりありがとうございました。',
'名称は 『%s』 で宜しいですか？',
'<strong>%s<\/strong> に決定しました。',
'%s は <strong>%s</strong> と命名されました。',
];

#プレースホルダー
#0.検索 1.ログインメールアドレス 2.お問い合わせ名前 3.お問い合わせメール 4.お問い合わせ内容 5.アプローチメッセージ 6.サイト内 7.カテゴリ内 8.フォーラム内 9.スレッド内 10.アップロード画像 11.コメントアップロード 12.命名権入力
$placeholder = ['Search...', 'example@yourmail.com', '', '', '', '一言メッセージ（必須ではありません）', 'サイト検索', $category. '検索', $forum. '検索', $forum_title[1]. '検索', '画像の説明', 'コメントファイルのアップロード', 'こちらに %s の名称を入力して下さい。', '入力必須です。'];
