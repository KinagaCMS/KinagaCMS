...
　「紀永」とは、*気長*の読みに当て字して「末永く書く」という意味を持たせた縁起の良い名称のコンテンツマネジメントシステムのことであり、ファイルシステムによるディレクトリ管理構造を特徴とすることから、データベースやアドミン権限を必要とせず、安全性の高い簡易CMSとして位置付けられます。
