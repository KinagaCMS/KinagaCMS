...
$html_assist = ['HTMLタグ入力補助', '自動改行', '緑地白文字', '黄緑地緑文字', '赤地白文字', 'ピンク地赤文字', '青地白文字', '水色地青文字', '黄色地白色文字', '淡黄地黄文字', '黒地白文字', '灰地白文字', '銀地黒文字', '白地黒文字', '区切り線', 'テーブル', 'リスト', 'リンク', '見出し H1', '見出し H2', '見出し H3', '見出し H4', '見出し H5', '見出し H6', '右寄せ', '中央寄せ', '大きい文字', '小さい文字', '太字', '斜体', '強調', '削除（打ち消し線）', '追加（下線）', '&amp;lt;&amp;gt;', 'br', 'address', 'blockquote', 'cite', 'code', 'dl', 'kbd', 'mark', 'samp', 'sub', 'sup'];
